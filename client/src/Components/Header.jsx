...
<span className='text-xl font-bold'>AgriMatrix</span>
    </Link>
    {/* <div className='flex gap-2 px-4 py-2 border border-gray-300 rounded-full shadow-md shadow-gray-300'>
      ...
      <div className="border-l border-gray-300"></div>
      <div>Add guests</div>
      <button className='p-1 text-white bg-teal-500 rounded-full'>
...
<path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
    ...
    <div className="overflow-hidden text-white bg-teal-500 border border-gray-500 rounded-full">
