    ...
    <div className="min-h-[85vh] flex items-center justify-center px-4 py-12 bg-gray-50 dark:bg-slate-950 font-sans transition-colors duration-200">
      <div className="w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-8 text-center">
          ...
          <h1 className="text-2xl font-semibold tracking-tight text-gray-900 dark:text-slate-100">Welcome Back</h1>
          <p className="mt-2 text-sm text-gray-500 dark:text-slate-400">Sign in to your AgroVision account</p>
        </div>
        ...
        <div className="px-6 py-8 bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 shadow-sm rounded-xl sm:px-10">
          ...
          {/* Error Alert */}
          {error && (
            <div className="flex items-center gap-3 p-3 mb-6 text-sm text-red-600 dark:text-red-400 border border-transparent bg-red-50 dark:bg-red-950/40 rounded-lg animate-fade-in">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                required
                className="block w-full h-11 px-3 py-2 text-gray-900 dark:text-slate-100 placeholder-gray-400 dark:placeholder-slate-500 transition-colors bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 sm:text-sm"
                autoComplete="email"
              />
            </div>
            ...
            <button 
              type="submit" 
              disabled={loading} 
              className="flex items-center justify-center w-full h-11 px-4 mt-2 text-sm font-medium text-white transition-colors bg-emerald-600 dark:bg-emerald-500 rounded-lg hover:bg-emerald-700 dark:hover:bg-emerald-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-600 disabled:opacity-70 disabled:cursor-not-allowed"
            >
              {loading ? (
                <>
