...
//     try {
//       await fetch(`${API}/input-entries/${id}`, {
//         method: 'DELETE',
//         credentials: 'include',
//       })
...
//           </div>
//           {MARKET_PRICES.map(p => (
//             <div key={p.crop} className="flex items-center justify-between p-4 card">
//               <div>
...
//                 </p>
//                 <p className={`text-xs font-medium ${trendColor[p.trend]}`}>
//                   {trendIcon[p.trend]} {p.change !== '0' ? p.change : 'Stable'}
//                 </p>
//               </div>
//             </div>
//           ))}
//           <p className="pt-2 text-xs text-center text-gray-400">
//             Prices are indicative. Check local Krishi Bhavan for exact rates.
//           </p>
//         </div>
//       )}
