...
import { Calendar, Plus, Inbox, ArrowLeft, Phone, User, MapPin, IndianRupee } from 'lucide-react'
import { getBookings, createBooking } from '../services/api'
import BookingCard from '../components/BookingCard'
      ...
      <div className="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-12 gap-6 bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm">
          <div>
            ...
            <p className="text-sm font-black tracking-widest uppercase text-emerald-600" style={{ fontFamily: 'Noto Sans Malayalam, sans-serif' }}>
              എന്റെ ബുക്കിങ്ങുകൾ
            </p>
          </div>
        ...
        {loading ? (
          ...
          <div className="p-8 text-red-700 border border-red-100 bg-red-50 rounded-[2rem] font-bold text-center">
            <span className="block mb-4 text-4xl">⚠️</span>
            {error}
          </div>
        ) : bookings.length === 0 ? (
          <motion.div 
          ...
          >
            ...
            <p className="mb-4 text-sm font-black tracking-widest uppercase text-emerald-600" style={{ fontFamily: 'Noto Sans Malayalam, sans-serif' }}>
              ഇതുവരെ ബുക്കിങ്ങ് ഇല്ല
            </p>
